...
### 1. GitHub Container Registry に登録された Docker イメージを参照する（推奨）
...
* [EMS・アグリゲーションコントローラー スマートメーターBルート(低圧スマート電力量メーター) 運用ガイドライン 第5.0版](https://www.meti.go.jp/shingikai/energy_environment/jisedai_smart_meter/pdf/20220531_2.pdf)
